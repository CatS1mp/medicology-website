...
export const LoginScreen: React.FC = () => {
    return (
        <div className="min-h-screen flex bg-white relative">
            ...
            <button className="absolute top-6 left-6 text-gray-400 hover:text-gray-600">
            ...
            <div className="absolute top-6 right-6">
                <button className="px-6 py-2.5 rounded-xl border-2 border-gray-200 text-[#51a8f6] font-bold text-sm tracking-wide hover:bg-gray-50 uppercase">
                    Login
                </button>
            </div>
